 ...
 */
export class FIDO2Strategy implements AuthStrategy {
    public readonly name: string = "fido2";
    private options: FIDO2StrategyOptions;
    ...
    protected async verify(req: HttpRequest, required?: boolean): Promise<AuthResult | undefined> {
        ...
        const genericFailure = (): Error => new Error("FIDO2 authentication failed.");
