...
/**
 * Implementation of the `AuthorizationCode` interface for storage in a MongoDB database. If SQL is desired,
 * please use `models.sql.AuthorizationCodeSQL` instead.
 *
...
export class AuthorizationCodeMongo extends BaseMongoEntity implements AuthorizationCode {
    @Column()
    @Identifier
    ...
    constructor(other?: Partial<AuthorizationCodeMongo>) {
        super(other);
