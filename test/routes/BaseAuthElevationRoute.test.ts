...
describe("BaseAuthElevationRoute Tests", () => {
    ...
    describe("updateSecretTimeStep", () => {
        ...
        // Regression: two concurrent elevation requests holding the same valid code both pass verification
        ...
        // and let a second session elevate on an already-used code.
